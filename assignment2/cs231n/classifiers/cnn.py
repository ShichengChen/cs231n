...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=[7],
               ...
               dtype=np.float32,conv_relu_pool_Layer = 1,fc_netLayer = 1):
    """
    ...
    self.params['W2'] = np.random.normal(0, weight_scale, (H2 * W2 * num_filters, hidden_dim[0]))
    self.params['b2'] = np.zeros(hidden_dim[0])
    self.params['W3'] = np.random.normal(0, weight_scale, (hidden_dim[0], num_classes))
