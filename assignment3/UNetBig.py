...
channels = 1
Xsz = 96
#regiony = 'G:/dataset/bigPixelImage2/'
regiony = 'G:/dataset/biggerPixel/'
regiony = 'G:/dataset/originalPixel/'
regiony = 'G:/dataset/cropedoriginalPixel2/'

#regiony = 'E:/PythonProject/dataset/bigPixelImage2/'
#regionx = 'E:/PythonProject/dataset/bighardPixelImage/'
#regionx = 'G:/dataset/bighardPixelImage/'
regionx = 'G:/dataset/biggerUS/'
regionx = 'G:/dataset/originalUS/'
regionx = 'G:/dataset/cropedoriginalUS2/'
...
def loadData():
    ...
    Xte = []
    Yte = []
    for name in np.arange(1,5):
        regiony = 'G:/dataset/cropedoriginalPixel%d/'%name
        regionx = 'G:/dataset/cropedoriginalUS%d/'%name
        print regionx
...
model = deeperUNet(input_dim=(Xtr[0].shape),h5_file = 'croped2',reg = reg, dtype=np.float32)
...
def writeData():
    for name in np.arange(1,5):
        regiony = 'G:/dataset/cropedoriginalPixel%d/'%name
        regionx = 'G:/dataset/cropedoriginalUS%d/'%name
        for i in np.arange(0, Ndata + Tdata):
