...
class DeconNet(object):
    ...
    def __init__(self, input_dim=(1, 24, 24),num_classes=2, weight_scale=1e-2, reg=0.0005,
        ...
        C, H, W = input_dim
        assert H == W
        num_filters = [1, 8, 8, 16, 16, 32, 32, 16, 16, 8, 8, 8, 2]
    ...
    def loss(self, X, y=None):
        ...
        X, self.c['con7'] = deconv_bn_relu_forward(X, p['W7'], p['b7'], p['gamma7'], p['beta7'],convp1, self.bn_params[7])
        ...
        X, self.c['con9'] = deconv_bn_relu_forward(X, p['W9'], p['b9'], p['gamma9'], p['beta9'],convp1, self.bn_params[9])
       ...
       '''
        ...
        dout, d['W9'], d['b9'], d['gamma9'], d['beta9'] = deconv_bn_relu_backward(dout, self.c['con9'])
        ...
        dout, d['W7'], d['b7'], d['gamma7'], d['beta7'] = deconv_bn_relu_backward(dout, self.c['con7'])
        ...
        dout, d['W3'], d['b3'], d['gamma3'], d['beta3'] = conv_bn_relu_backward(dout,self.c['con3'])
        dout, d['W2'], d['b2'], d['gamma2'], d['beta2'] = conv_bn_relu_backward(dout, self.c['con2'])
        dout = max_pool_backward_fast(dout, self.c['p0'])
        dout, d['W1'], d['b1'], d['gamma1'], d['beta1'] = conv_bn_relu_backward(dout,self.c['con1'])
